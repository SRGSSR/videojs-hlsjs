  ...
  var Hlsjs = videojs.extend(Html5, {
    ...
    onManifestParsed: function() {
      ...
      if (this._levels.length > 0) {
        ...
        if (!hasAutoLevel && !this.options_.setLevelByHeight) {
          var level = this._levels[this._levels.length-1];
          this.setLevel(level);
          this.hls_.startLevel = level.index;
        } else if (this.options_.setLevelByHeight) {
          var startLevel = this._getLevelByHeight(this.options_.setLevelByHeight);
          ...
          var startLevel = this._getLevelByHeight(this.options_.startLevelByHeight);
    ...
    currentLevel: function() {
      ...
      return (this._forceLevel.index === -1) ?
                this._levels[(hasAutoLevel) ? this.hls_.currentLevel+1  : this.hls_.currentLevel] :
                this._forceLevel;
    },
